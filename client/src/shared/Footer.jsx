        ...
        <ul className="flex items-center space-x-5">
          <li className="text-center">
            <Link
              ...
              to="https://www.facebook.com/groups/learnwithsumit/"
            >
              <svg
                height="24"
                version="1.1"
          ...
          <li className="text-center">
            <Link
              className="transition-all duration-200 text-white/50 hover:text-white"
              to="https://www.youtube.com/c/learnwithsumit"
            >
              <svg
                height="24"
                id="Layer_1"
          ...
          <li className="text-center">
            <Link
              className="transition-all duration-200 text-white/50 hover:text-white"
              to="https://twitter.com/i/flow/login?redirect_after_login=%2Flearnwithsumit"
            >
              <svg
                height="24"
                id="Layer_1"
